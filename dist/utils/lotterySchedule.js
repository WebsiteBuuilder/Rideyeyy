...
exports.lastLotteryDrawUtc = lastLotteryDrawUtc;
exports.nextLotteryDrawUtc = nextLotteryDrawUtc;
/** Most recent occurrence of (dayOfWeek, hourUtc) at or before `now` (UTC). */
function lastLotteryDrawUtc(dayOfWeek, hourUtc, now) {
...
function nextLotteryDrawUtc(dayOfWeek, hourUtc, now) {
